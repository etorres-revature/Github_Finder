...
If you have ideas for imporovements or suggestions for further features, please e-mail the address below.
...
This *Github Finder* was built by :green_heart: Eric D. Torres :green_heart:
...
[This application uses the **MIT** found here](./LICENSE).
